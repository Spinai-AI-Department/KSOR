    ...
    <div className="p-4 md:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 md:mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">{dateFrom} ~ {dateTo} 성과 리포트</p>
        </div>
          ...
          {showDatePicker && (
            <div className="flex items-center gap-2">
              <input
                ...
                className="px-2 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            ...
            <table className="w-full min-w-[500px]">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-600">
                  ...
                  <th className="text-right py-3 px-4 text-sm text-gray-600 dark:text-gray-400">합병증 비율</th>
                </tr>
              </thead>
              <tbody>
